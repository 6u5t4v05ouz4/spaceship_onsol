 ...
 * Suporta apenas OAuth Google (simplificado para Story 2.1)
 */
...
export default class LoginPage {
  ...
  attachListeners(container) {
    ...
    // OAuth button - only Google login now
  ...
  /**
   * Setup form validation - removed since we only use Google OAuth now
   */
  setupFormValidation(container) {
    // No validation needed for Google OAuth only
  }
